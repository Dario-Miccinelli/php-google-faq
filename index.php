...
$FAQ = [
    ...
    [
        ...
        "answer" =>  [
            ...
            '<ul></li><li>',
            "2. Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.",
            '</li><li>',
            "3. Google LLC, con sede negli Stati Uniti, per il resto del mondo.",
            '</li></ul><li>',
            "4. La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.",
            '</li></ul>',
...
<body>
    <header class="d-flex align-items-center justify-content-between">
        ...
        <div class="header-part d-flex align-items-center">
            ...
            <!-- mia foto profilo google  -->
            <div>
                <img src="https://lh3.googleusercontent.com/ogw/AOh-ky3aw8miYg2DCHBidNr_KBE8ol-02ElKJQgwH4srEQ=s32-c-mo" alt="">
            </div>
    ...
    <main>
        ...
        <div class="under-header p-2 ">

            <span>Introduzione</span>
            <span>Norme sulla privacy</span>
            <span>Termini di servizio</span>
            <span>Tecnologie</span>
            <span class="underline">Domande frequenti</span>

        </div>

        <div class="container w-75 text-left p-5 mt-1 ">
            <?php foreach ($FAQ as $sectionFAQ) { ?>
                <h1 class="mb-4"><?php echo $sectionFAQ['question']; ?></h1>
                <?php foreach ($sectionFAQ['answer'] as $key) { ?>
                    <p class="font"><?php echo $key; ?></p>
                <?php } ?>
            <?php } ?>
...
<style>
    ...
    * {
    ...
    body>header>div.logoTitolo>span {
        margin-left: 10px;
    }
    ...
    /* MAIN CICLATO CON PHP FONT-SIZE */
    .font {
        font-size: 0.95rem;
    }
</style>